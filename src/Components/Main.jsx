  ...
  return (
    <main>
      <section className="w-full mx-auto py-32 items-center flex flex-col justify-center">
        ...
        <h2 className="text-xl opacity-60 pb-8 text-center max-md:w-full w-3/5 max-md:text-lg mb-3  text-gray-400">
      ...
      <section className="flex flex-col w-full items-center mx-auto py-2">
        <div>
          <div className="flex text-center text-3xl font-bold pb-4 text-white">Ultimas Noticias</div>
        </div>
